...
CREATE TABLE IF NOT EXISTS organization_settings (
    ...
    ews_high_threshold      SMALLINT NOT NULL DEFAULT 5,
    ews_urgent_threshold    SMALLINT NOT NULL DEFAULT 7,
    alert_cooldown_minutes  SMALLINT NOT NULL DEFAULT 15,
    icu_auto_assign         BOOLEAN  NOT NULL DEFAULT TRUE,
    escalation_wait_minutes SMALLINT NOT NULL DEFAULT 10,
    updated_at              TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
