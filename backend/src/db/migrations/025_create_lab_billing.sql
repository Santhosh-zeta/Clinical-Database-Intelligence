-- ============================================================
-- Migration 025: Lab Investigations and Billing
-- ============================================================
...
CREATE TABLE IF NOT EXISTS lab_tests (
    ...
    category    VARCHAR(50), -- 'blood', 'urine', 'imaging', etc.
    normal_range TEXT,
...
CREATE TABLE IF NOT EXISTS lab_orders (
    ...
    priority        VARCHAR(20) DEFAULT 'routine', -- 'routine', 'stat', 'urgent'
...
CREATE TABLE IF NOT EXISTS billing_invoices (
    ...
    status          VARCHAR(20) DEFAULT 'draft', -- 'draft', 'issued', 'partially_paid', 'paid', 'void'
...
CREATE TABLE IF NOT EXISTS billing_items (
    ...
    item_type       VARCHAR(50) NOT NULL, -- 'room', 'medication', 'lab', 'procedure', 'consultation'
